...
@section('page_heading', 'Edit Blog')

@section('section')

	<div class="col-sm-12">
		<div class="row">
			<form action="{{ route('blog.update', ['blog' => $blog->slug]) }}" method="post">
				{{ csrf_field() }}
				{{ method_field('put') }}
				<div class="col-sm-8">
					<div class="row">
														...
														@foreach($tags as $tag)
															<li>
																<span>
																	...
																	<a href="javascript:" class="removeTagBtn" data-tags="{{ $tag->name }}">
																		<i class="fa fa-close"></i>
																	</a>
																</span>
																&nbsp; {{ $tag->name }}
...
@section('script')
	@include('admin.blog.script._script_edit')
@endsection