...
@section('page_heading', 'Create New Product')
									...
									<div class="row">
										<div class="col-sm-12">
											@foreach($categories as $key => $cat)
												 <div class="radio">
										         	<label>
										          		<input name="category" value="{{ $cat->id }}" type="radio" {{ $key == 0 ? 'checked' : '' }}>
										          		{{ $cat->name }}
										         	</label>
										    	</div>
											@endforeach
						...
						<div class="col-sm-12">
							@component('admin.widgets.panel')
								...
								@slot('panelBody')
									<div class="row">
										<div class="col-sm-12">
											<div class="addGalleryImageContainer hidden row">
...
@section('script')
	@include('admin.product.script._create')
@endsection